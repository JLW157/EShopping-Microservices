...
public class CatalogContext : ICatalogContext
{
    ...
    public CatalogContext(IConfiguration configuration)
    {
        ...
        Brands = database.GetCollection<ProductBrand>(configuration
            .GetValue<string>("DatabaseSettings:BrandsCollection"));
        
        Types = database.GetCollection<ProductType>(configuration
            .GetValue<string>("DatabaseSettings:TypesCollection"));
